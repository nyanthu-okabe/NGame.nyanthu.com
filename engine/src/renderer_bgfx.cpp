...
#include "platform/platform_utils.h" // For getNativeWindowHandle
...
public:
    ...
    {
        // This view is cleared to the default color
        bgfx::touch(0);
    }

    void endFrame() override
    {
        // Advance to next frame. Rendering thread will start processing this frame.
        bgfx::frame();
    }
    ...
    // --- Minimal Implementation: Empty draw calls ---
